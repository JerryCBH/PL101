  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_qoute() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a) {return ["qoute", a];})(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_subexpr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, b, c) {return a.concat(b).concat(c);})(pos0, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          result0 = parse_bracket();
        }
        return result0;
      }
